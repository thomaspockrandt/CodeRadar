...
namespace CodeRadar
{
    ...
    /// </summary>
    internal sealed class EndOfDocViewportAdornment
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EndOfDocViewportAdornment"/> class.
        /// Creates a square image and attaches an event handler to the layout changed event that
        /// adds the the square in the upper right-hand corner of the TextView via the adornment layer
        /// </summary>
        /// <param name="view">The <see cref="IWpfTextView"/> upon which the adornment will be drawn</param>
        public EndOfDocViewportAdornment(IWpfTextView view)
        {
            if (view == null)
            {
            ...
            this.adornmentLayer = view.GetAdornmentLayer("EndOfDocViewportAdornment");
